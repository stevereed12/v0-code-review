    ...
    <div className="min-h-screen bg-[#060a10]">
      ...
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="prose prose-invert prose-sm max-w-none space-y-6 text-[#d6dff0]">
          ...
          <section>
            <h2 className="text-xl font-bold text-white mt-8 mb-4">3. Not Financial Advice</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mt-8 mb-4">4. User Accounts</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mt-8 mb-4">5. API Keys</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mt-8 mb-4">6. Subscription and Billing</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mt-8 mb-4">7. Acceptable Use</h2>
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:legal@white80.io" className="text-[#00e5ff] hover:underline">
                legal@white80.io
              </a>
            </p>
          </section>
